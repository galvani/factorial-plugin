...
class ConnectwiseIntegrationTest extends AbstractIntegrationTestCase
{
     ...
     *
     * @covers \MauticPlugin\MauticFactorialBundle\Integration\ConnectwiseIntegration::getRecords
     */
     ...
     * @testdox Test that all records are fetched till last page of results are consumed
     *
     * @covers \MauticPlugin\MauticFactorialBundle\Integration\ConnectwiseIntegration::getCampaignMembers
     */
